  ...
  return (
    <StyledWrapper>
      <div className="card">
          ...
          <a href="https://www.instagram.com/ministerio_tic" target='_blank'  className="socialContainer containerOne">
        ...
        <a href="https://www.tiktok.com/@ministerio_tic" target='_blank' className="socialContainer containerTwo">
        ...
        <a href="https://www.facebook.com/MinisterioTIC.Colombia/" target='_blank' className="socialContainer containerThree">
          <div>
        ...
        <a href="https://api.whatsapp.com/send/?phone=573227234164&text&type=phone_number&app_absent=0" target='_blank' className="socialContainer containerFour">
...
const StyledWrapper = styled.div`
  ...
  .card {
    ...
    border-radius: 15px;
    gap: 10px;
    box-shadow: 0px 0px 20px #C3F3C0;
    opacity: 0.9;
  }
  ...
  .socialContainer {
    ...
    cursor: pointer; /* Asegura que el cursor cambie en toda el área */
    position: relative; /* Asegura posicionamiento correcto */
  }


  /* Estilo existente para los contenedores individuales */
  .containerOne:hover {
  ...
  .socialSvg {
    width:25px;
    height: auto;
     z-index: 1; /* SVG debajo del enlace */
    pointer-events: none; /* Para evitar interferencia del cursor en el SVG */
  }
  .largeIcon {
    width: 32px;
  }
